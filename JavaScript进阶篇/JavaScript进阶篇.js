...
插入节点：appendChild(newNode)
	...
	参数:newnode：指定追加的节点。
	// 代码参见"9-12 插入节点appendChild.html"

插入节点：insertBefore(newNode,node)
	insertBefore() 方法可在已有的子节点前插入一个新的子节点。
	参数:
	newnode: 要插入的新节点。
	node: 指定此节点前插入节点。
	// 代码参见"9-13 插入节点insertBefore"

删除节点：nodeObject.removeChild(node)
	removeChild() 方法从子节点列表中删除某个节点。如删除成功，此方法可返回被删除的节点，如失败，则返回 NULL。
	参数:
	node ：必需，指定需要删除的节点。
	// 代码参见"9-14 删除节点removeChild.html"

替换元素节点：node.replaceChild(newnode,oldnew)
	replaceChild 实现子节点(对象)的替换。返回被替换对象的引用。
	参数：
	newnode : 必需，用于替换 oldnew 的对象。 
	oldnew : 必需，被 newnode 替换的对象。
	// 代码参见"9-15 替换元素节点replaceChild.html"
...
创建元素节点：document.createElement(tagName);
	...
	// 代码参见"9-16 创建元素节点createElement.html"

创建文本节点：document.createTextNode(data);
	createTextNode() 方法创建新的文本节点，返回新创建的 Text 节点。
	参数：
	data : 字符串值，可规定此节点的文本。
	// 代码参见"9-17 创建文本节点createTextNode.html"
...
网页尺寸：
	...
	// 代码参见"9-20 网页尺寸offsetWidth/Height.html"

网页卷去的距离与偏移量：
	// 图片见文件夹内"网页卷去的距离与偏移量.png"
